...
## Exporting WSL to another drive

If the `C:` drive of your Windows is running out of space, you can export your WSL distribution to another drive and import it back. First, list your WSL distributions and follow the steps below:

```bash
wsl --list

wsl --export Ubuntu-24.04 D:/ubuntu-2404.tar

wsl --unregister Ubuntu-24.04

wsl --import Ubuntu-24.04 D:/WSL/Ubuntu-24.04/ D:/ubuntu-2404.tar
```
