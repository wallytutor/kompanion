...
In these notes we provide a Finite Volume Method relecture to the famous [The 12 steps to Navier-Stokes equations](https://jose.theoj.org/papers/10.21105/jose.00021), by Lorena A. Barba and Gilbert F. Forsyth. It is not a bare translation, but a different approach to the problems with the addition of new elements, some sort of _Twelve-steps to Navier Stokes rewind_.
...
- [x] Simple Fick's Law with possible nonlinear behavior in one-dimension on [chapter @sec-diffusion-in-1-d].
...
_Upcoming_ in [@sec-convection-in-1-d]!
